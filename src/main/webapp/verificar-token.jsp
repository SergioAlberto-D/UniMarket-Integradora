<%--
  ...
  Archivo: src/main/webapp/verificar-token.jsp
  Propósito: Recurso de vista JSP para el módulo verificar-token. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
