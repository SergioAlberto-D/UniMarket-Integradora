<%--
  ...
  Archivo: src/main/webapp/registro.jsp
  Propósito: Recurso de vista JSP para el módulo registro. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
