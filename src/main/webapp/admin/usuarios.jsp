<%--
  ...
  Archivo: src/main/webapp/admin/usuarios.jsp
  Propósito: Recurso de vista JSP para el módulo usuarios. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
