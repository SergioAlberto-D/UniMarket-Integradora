<%--
  ...
  Archivo: src/main/webapp/components/header.jsp
  Propósito: Recurso de vista JSP para el módulo header. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
