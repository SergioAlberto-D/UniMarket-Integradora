<%--
  ...
  Archivo: src/main/webapp/recuperar-password.jsp
  Propósito: Recurso de vista JSP para el módulo recuperar-password. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
