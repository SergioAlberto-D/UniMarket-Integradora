<%--
  ...
  Archivo: src/main/webapp/editar-articulo.jsp
  Propósito: Recurso de vista JSP para el módulo editar-articulo. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
