<%--
  ...
  Archivo: src/main/webapp/historial-actividad.jsp
  Propósito: Recurso de vista JSP para el módulo historial-actividad. Integra HTML, JSTL y/o expresiones JSP según el contenido fuente.
